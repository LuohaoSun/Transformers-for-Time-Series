...
class SinPosEmbedding(nn.Module):
    ...
    def __init__(self, d_model, max_len=200):
        ...
        div_term = torch.pow(10000.0, -torch.arange(0, d_model, 2, dtype=torch.float32) / d_model)
...
class RotaryPosEmbedding(nn.Module):
    ...
    def apply_rotary_embedding(self, x, rotary_emb):
        ...
        return torch.cat(((x1 * rotary_emb1 - x2 * rotary_emb2), (x1 * rotary_emb2 + x2 * rotary_emb1)), dim=-1)
